...
* **Разметка и стилизация**
  * [Так кнопка или ссылка?](btn-or-link)
  * [Следите, чтобы документы не ссылались сами на себя, и учитывайте это в CSS](self-linking)
* **Типографика**
...
<h3 id="btn-or-link">Так кнопка или ссылка?</h3>
...
<h3 id="line-height-px">Не пишите высоту строки в пикселях</h3>
