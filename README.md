...
* **Разметка и стилизация**
  * [Так кнопка или ссылка?](https://github.com/biggus-dickus/frontend-tips/blob/master/README.md#%D1%82%D0%B0%D0%BA-%D0%BA%D0%BD%D0%BE%D0%BF%D0%BA%D0%B0-%D0%B8%D0%BB%D0%B8-%D1%81%D1%81%D1%8B%D0%BB%D0%BA%D0%B0)
  * [Следите, чтобы документы не ссылались сами на себя, и учитывайте это в CSS](#%D0%BD%D0%B5-%D0%BF%D0%B8%D1%88%D0%B8%D1%82%D0%B5-%D0%B2%D1%8B%D1%81%D0%BE%D1%82%D1%83-%D1%81%D1%82%D1%80%D0%BE%D0%BA%D0%B8-%D0%B2-%D0%BF%D0%B8%D0%BA%D1%81%D0%B5%D0%BB%D1%8F%D1%85)
* **Типографика**
  * [Не пишите высоту строки в пикселях](line-height-px)
* **Практические советы**
  * [Не привязывайте CSS-правила к HTML-селекторам и их расположению в документе](dont-style-selectors)
  * [Избегайте чрезмерных обобщений, собирайте макет как конструктор](overgeneralizing)
  * [Не используйте настройки Автопрефиксера по умолчанию](default-autoprefixer)
...
<h3 id="dont-style-selectors">Не привязывайте CSS-правила к HTML-селекторам и их расположению в документе</h3>
...
<h3 id="overgeneralizing">Избегайте чрезмерных обобщений, собирайте макет как конструктор</h3>
...
<h3 id="default-autoprefixer">Не используйте настройки Автопрефиксера по умолчанию</h3>
